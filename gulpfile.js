...
var PIXEL_ENDPOINT =
  process.env.OPIX_PIXEL_ENDPOINT || 'https://pixel.blabberjax.com/api/Pixel/Track.jpg';
...
function snippet() {
  return (
    gulp
      ...
      .pipe(decomment())
      // .pipe(uglify())
      .pipe(inject.prepend('<!-- Start BlabberJax Pixel Snippet -->\n<script>\n'))
      .pipe(inject.append('\n</script>\n<!-- End BlabberJax Pixel Snippet -->'))
