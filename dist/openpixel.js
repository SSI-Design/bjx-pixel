// Blabberjax Pixel, based on Open Pixel v1.3.1 | Published By Dockwa | Created By Stuart Yamartino | MIT License
    ...
    value: function getAttribute() {
      ...
      if (window.hasOwnProperty('CONSENT_ACCEPTED') && window.CONSENT_ACCEPTED) {
        return _objectSpread({
          ...
          consent_accepted: function consent_accepted(key) {
            return window['CONSENT_ACCEPTED'];
          }
        }, Config.params);
      } else {
        return {
...
}(window, document, window["opix"], "opix", "https://schedule.blabberjax.com/pixel/api/Pixel/Track.jpg", 1));
